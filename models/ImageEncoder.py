...
class ImageEncoder(nn.Module):
    def __init__(self, embed_dim):
        ...
        self.conv_1 = nn.Conv2d(in_channels = 3, out_channels = 16, kernel_size = 3, stride = 1, padding = "same")
        ...
        self.conv_5 = nn.Conv2d(in_channels = 128, out_channels = embed_dim, kernel_size = 1, stride = 1, padding = "same")
